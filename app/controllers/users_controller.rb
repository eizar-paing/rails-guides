class UsersController < ApplicationController
  ...
  def new
    @user = User.new
    # we need to tell the system to use the association
  ...
  def correct_admin
    # id: params[:id] => why not admin_id
    # because devise give it the primary key id
    @user = current_admin.users.find_by(id: params[:id])
    redirect_to users_path, notice: "Not Authorized to edit or delete this user" if @user.nil?
  end
